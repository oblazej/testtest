...
export default function Personal() {
    ...
    return (
        <div className='bg-beige-light border-b border-[#000] pb-28'>
            ...
            <p className='font-mont font-medium uppercase text-moreabout text-right tracking-moreabout pt-8 border-b-2 border-[#000] w-60 pb-4'>
                <a>

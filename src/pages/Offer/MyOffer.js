    ...
    return (
        ...
        <div className='py-16 font-ivy font-thin uppercase text-offer text-center leading-offer tracking-offer xl:text-offerbig xl:leading-titlebig xl:tracking-offerbig'>
          ...
          <p className='font-mont font-medium uppercase text-moreabout text-center leading-moreabout tracking-writeme mt-12'>
            <a href={t('offer.link_offer')}>
              {t('offer.my_offer')}
            </a>
          </p>
          <div className='flex justify-center pb-5 xl:pb-0'>
            <div className='border-t-2 border-[#000] w-6 m-1.5'></div>
          </div>
          </div>
          <div className='flex flex-col justify-center'>
          <p className='font-mont font-medium uppercase text-moreabout text-center leading-moreabout tracking-writeme mt-12 pt-5 xl:pt-0'>
            <a href={t('offer.link_form')}>
              {t('offer.form')}
            </a>
          </p>

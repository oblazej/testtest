...
export default function Logo(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} viewBox="0 0 315 46">
      <defs>
      ...
      <g id="Artboard_1" data-name="Artboard – 1" clipPath="url(#clip-Artboard_1)">
        ...
        <g id="Group_494" data-name="Group 494" transform="translate(-242.504 -210.255)">
          ...
          <path id="Path_70" data-name="Path 70" d="M291.712,233.7c-.648,1.764-3.122,7.124-3.122,9.008,0,1.472.942,2.177,2.3,2.589h-5.712a5.126,5.126,0,0,0,2.709-2.945l9.95-26.257,9.6,26.137a4.718,4.718,0,0,0,2.531,3.064h-6.005a2.442,2.442,0,0,0,1.53-2.239c0-1.116-2.766-7.949-3.239-9.358Zm.117-.412h10.127l-5-13.6Z" transform="translate(12.572 1.513)" fill="#161615" stroke="#161615" strokeMiterlimit="10" strokeWidth="0.377" />
          ...
          <path id="Path_72" data-name="Path 72" d="M330.827,242.314a2.777,2.777,0,0,0,1.823,2.943h-5.71a2.678,2.678,0,0,0,1.884-2.943v-22.9c0-1.476-.472-2.536-1.884-3.006h5.71c-1.412.47-1.823,1.593-1.823,3.006v10.83h15.424v-10.83c0-1.413-.412-2.536-1.824-3.006h5.71c-1.412.47-1.824,1.593-1.824,3.006v22.844c0,1.41.413,2.532,1.824,3h-5.71c1.412-.47,1.824-1.591,1.824-3V230.716H330.827Z" transform="translate(25.151 1.608)" fill="#161615" stroke="#161615" strokeMiterlimit="10" strokeWidth="0.377" />
          <path id="Path_73" data-name="Path 73" d="M352.963,242.255c0,1.41.413,2.532,1.824,3h-5.71c1.412-.47,1.884-1.53,1.884-3V219.412c0-1.476-.472-2.536-1.884-3.006h5.71c-1.412.47-1.824,1.593-1.824,3.006Z" transform="translate(31.818 1.608)" fill="#161615" stroke="#161615" strokeMiterlimit="10" strokeWidth="0.377" />
          <path id="Path_74" data-name="Path 74" d="M382.968,241.1c-2.706,2.239-7.064,4.3-10.654,4.3a14.543,14.543,0,1,1,0-29.085c3.06,0,7.063.705,9.419,2.766v3.533c-2.3-3.3-5.946-5.772-10.01-5.772-7.3,0-11.422,6.122-11.422,12.953,0,7,4.358,15.073,12.247,15.073,4.064,0,7.654-2.411,10.007-5.71Z" transform="translate(34.436 1.581)" fill="#161615" stroke="#161615" strokeMiterlimit="10" strokeWidth="0.377" />
          ...
          <path id="Path_76" data-name="Path 76" d="M425.9,242.211c0,1.409.411,2.531,1.824,3h-5.711c1.412-.471,1.884-1.53,1.884-3V219.368c0-1.477-.472-2.536-1.884-3.006h5.711c-1.413.47-1.824,1.591-1.824,3.006Z" transform="translate(53.786 1.594)" fill="#161615" stroke="#161615" strokeMiterlimit="10" strokeWidth="0.377" />
          <path id="Path_77" data-name="Path 77" d="M438.283,244.041a2.53,2.53,0,0,0,1.824,2.766h-5.652a2.641,2.641,0,0,0,1.884-2.825v-27.2c-4.121-.178-9.065-1.18-12.13-4.243l.178-.527c3.239,3,6.888,4,11.186,4,8.948,0,17.131-4.947,26.082-4.947,4.77,0,9.185.945,12.307,4.77l-.532.234c-2.294-3.47-5.769-4.181-9.713-4.181-8.715,0-16.721,4.891-25.434,4.891Z" transform="translate(54.446)" fill="#161615" stroke="#161615" strokeMiterlimit="10" strokeWidth="0.377" />
